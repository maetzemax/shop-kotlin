    ...
    Container {
        ...
        if (editMode.displayName || editMode.email || editMode.password) {
            PrimaryButton({
                ...
                if (editMode.displayName) {
                    settingsScreenViewModel?.updateDisplayName(displayName, error, setError, navigator)
                } else if (editMode.email) {
                    settingsScreenViewModel?.updateEmail(email, error, setError, navigator)
                } else {
                    settingsScreenViewModel?.updatePassword(password, error, setError, navigator)
                }
            ...
            PrimaryTextButton({
                ...
                settingsScreenViewModel?.abort(setEditMode, setDisplayName, setEmail, setPassword)
            }
        } else {
            PrimaryButton({
                Text("Logout")
